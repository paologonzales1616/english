...
class Answer8Page extends StatefulWidget {
  Answer8Page({
  ...
  @override
  _Answer8PageState createState() => _Answer8PageState();
}

class _Answer8PageState extends State<Answer8Page> {
            ...
            children: <Widget>[
              ...
              Card(
                child: Padding(
                  padding: EdgeInsets.all(8.0),
                  child: Text(
                    "Answer: It was the safe refuge of the American Governors-General.",
                    style: TextStyle(fontSize: 18.0),
                  ),
                ),
              ),
